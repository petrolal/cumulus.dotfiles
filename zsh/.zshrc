...
# ~/.config/dotfiles/zsh_config/*.zsh — see scripts/install-zsh.sh and the
...
# ── Load modular config from ~/.config/dotfiles/zsh_config/ ──
ZSH_CONFIG_DIR="$HOME/.config/dotfiles/zsh_config"
